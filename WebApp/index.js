...
app.get("/data/maps/:imgId/radar.png", (req, res) => {
    res.sendFile(__dirname + "/data/maps/" + req.params.imgId + "/radar.png");
});
...
app.listen(web_port, () => {
    console.log("listening on port %i", web_port);
});
